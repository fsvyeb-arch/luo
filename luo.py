...
# --- 2. 完整全台 ETF 資料庫 (共 69 檔) ---
ETF_MASTER_LIST = [
    ["0050", "元大台灣50", "1,7月", "0.32%", "0.035%"], ["0051", "元大中型100", "11月", "0.4%", "0.035%"],
    ["0052", "富邦台灣科技", "4月", "0.15%", "0.035%"], ["0053", "元大台灣電子", "11月", "0.3%", "0.035%"],
    ["0055", "元大MSCI金融", "11月", "0.3%", "0.035%"], ["0056", "元大台灣高股息", "10月", "0.3%", "0.035%"],
    ["0057", "富邦摩台", "6月", "0.15%", "0.035%"], ["006201", "元大富櫃50", "12月", "0.4%", "0.035%"],
    ...
    ["00901", "永豐智能車供應", "10月", "0.4%", "0.04%"], ["00904", "新光臺灣半導體30", "季配", "0.4%", "0.035%"],
    ["00905", "FT臺灣Smart", "季配", "0.4%", "0.035%"], ["00907", "永豐優選存股", "雙月配", "0.4%", "0.03%"],
    ["00912", "中信智慧50", "季配", "0.3%", "0.035%"], ["00913", "兆豐晶圓製造", "1,7月", "0.4%", "0.03%"],
    ["00915", "凱基優選高股息", "季配", "0.3%", "0.035%"], ["00918", "大華高填息30", "季配", "0.35%", "0.035%"],
    ["00919", "群益精選高息", "3,6,9,12月", "0.3%", "0.035%"], ["00921", "兆豐龍頭等權重", "季配", "0.45%", "0.03%"],
    ["00922", "國泰領袖50", "3,10月", "0.20%", "0.035%"], ["00923", "群益 ESG 低碳 50", "2,8月", "0.32%", "0.035%"],
    ["00927", "群益半導體收益", "1,4,7,10月", "0.4%", "0.035%"], ["00928", "中信上櫃ESG30", "1,7月", "0.4%", "0.035%"],
    ["00929", "復華科技優息", "每月", "0.30%", "0.030%"], ["00930", "永豐低碳高息", "單月配", "0.35%", "0.035%"],
    ["00932", "兆豐永續高息等權", "季配", "0.15%", "0.030%"], ["00934", "中信成長高股息", "每月", "0.3%", "0.035%"],
    ["00935", "野村創新科技50", "3,9月", "0.4%", "0.035%"], ["00936", "台新永續高息中小", "每月", "0.4%", "0.035%"],
    ["00938", "凱基優選30", "季配", "0.3%", "0.35%"], ["00939", "統一高息動力", "每月", "0.3%", "0.035%"],
    ["00940", "元大台灣價值高息", "每月", "0.3%", "0.03%"], ["00943", "兆豐電子高息等權", "每月", "0.25%", "0.03%"],
    ["00944", "野村趨勢動能高息", "每月", "0.4%", "0.035%"], ["00946", "群益科技高息成長", "每月", "0.3%", "0.03%"],
    ["00947", "台新IC設計動能", "季配", "0.40%", "0.03%"], ["00952", "凱基台灣AI 50", "每月", "0.40%", "0.03%"],
    ["00961", "FT臺灣永續高息", "每月", "0.30%", "0.035%"], ["00962", "台新AI優息動能", "每月", "0.40%", "0.035%"],
    ["009802", "富邦旗艦50", "季配", "0.15%", "0.03%"], ["009803", "保德信市值50", "季配", "0.25%", "0.035%"],
    ["009804", "聯邦精彩50", "4,7月", "0.15%", "0.035%"], ["009808", "華南永昌優選50", "季配", "0.05%", "0.035%"],
    ["009809", "富邦淨零ESG 50", "季配", "0.30%", "0.035%"], ["00980A", "野村智慧優選主動", "季配", "0.75%", "0.035%"],
    ["00981A", "統一台股增長主動", "10月", "1.0%", "0.10%"], ["00982A", "群益精選強棒主動", "季配", "0.8%", "0.035%"],
    ["00984A", "安聯高息成長主動", "季配", "0.7%", "0.04%"], ["00985A", "野村台灣增強50主動", "1月", "0.45%", "0.035%"],
